    ...
    try {
      ...
      if (path === "/api/voice/report" && method === "POST") {
        ...
        if (contentType.includes("multipart/form-data")) {
          ...
          const reconquistaPrompt = `Reporte ciudadano en Reconquista, Santa Fe, Argentina. Calles: Habegger, Iriondo, Pellegrini, Rivadavia, Avellaneda, Belgrano, San Martín, Mitre, Roca, Colón, Sarmiento, Tucumán, Córdoba, Mendoza, Entre Ríos, Corrientes, Santa Fe, La Rioja, San Juan, Moreno, Iturraspe, Ituzaingó, Almafuerte, Chacabuco, Freyre, Ludueña, Bolívar, Alvear, España, Italia, Francia, Independencia, Libertad, 25 de Mayo, 9 de Julio, Bulevar Lovato, Bulevar Constituyentes, Ruta Nacional 11, Patricio Diez, Amenabar. Calles numeradas: Calle 41, Calle 43, Calle 44, Calle 45, Calle 46, Calle 47, Calle 48, Calle 50, Calle 52, Calle 54, Calle 56, Calle 58, Calle 60, Calle 62. Problemas: bache, pozo, basura, residuos, recolección de basura, alumbrado, luz, farol, semáforo, pastizal, yuyos, pasto alto, pérdida de agua, fuga de agua, cañería rota, alcantarillado, drenaje, banqueta, vereda dañada, semáforo descompuesto, limpieza, falta de limpieza, graffiti, vandalismo, escombros, cascotes, árbol caído, árbol peligroso, rama caída, daños a propiedad pública, vehículo abandonado, auto abandonado, falta de iluminación, animales callejeros, perros sueltos, plagas, señalización dañada, cartel roto, estacionamiento, transporte público, choque, accidente de tránsito.`;
